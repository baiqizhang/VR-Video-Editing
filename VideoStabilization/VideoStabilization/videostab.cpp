                                          ...
                                          std::vector<AffineTransformParam> & optimal_transform )
{
    ...
    {
        set_bounds( lp, p_shift + i * e_num + 1, -hcrop, hcrop );
        set_bounds( lp, p_shift + i * e_num + 2, -vcrop, vcrop );
        set_bounds( lp, p_shift + i * e_num + 3, a_lb, a_ub );
        set_bounds( lp, p_shift + i * e_num + 4, b_lb, b_ub );
    }
...
bool VideoStablizer::run( std::string output_path )
{
    ...
    //        printf( "%f %f %f %f %f %f\n", param._x, param._y, param._a, param._b, param._c, param._d );
    //    }
